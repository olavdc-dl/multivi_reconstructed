...
# https://github.com/DisnakeDev/disnake/blob/7853da70b13fcd2978c39c0b7efa59b34d298186/docs/conf.py#L192
_scvi_local_module_path = os.path.dirname(importlib.util.find_spec("scvi").origin)  # type: ignore
...
def linkcode_resolve(domain, info):
    ...
    try:
        ...
        path = os.path.relpath(inspect.getsourcefile(obj), start=_scvi_local_module_path)  # type: ignore
