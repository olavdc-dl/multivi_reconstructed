...
from scvi_local.module import Classifier
from scvi_local.module.base import (
    BaseModuleClass,
    JaxBaseModuleClass,
    LossOutput,
    PyroBaseModuleClass,
...
from scvi_local.train._constants import METRIC_KEYS
...
class AdversarialTrainingPlan(TrainingPlan):
    ...
    **loss_kwargs
    ...
    def training_step(self, batch, batch_idx):
        ...
        # x = batch["X"]
        # print(f"x batch {batch_idx} : {x.sum()}")
        ...
        # if batch_idx % 40 == 0:
        #     print(f" kl_weight batch {batch_idx} : {self.kl_weight}")

        # self.log("fool_loss", fool_loss, on_step = True)
